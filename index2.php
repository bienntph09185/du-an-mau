...
<form id="add-save-from" action="<?= BASE_URL . 'save-add.php'?>" method="post" enctype="multipart/form-data">
...
<div class="col-12 d-flex justify-content-end">
                           ...
                           <button  type="submit" class="btn btn-primary" name="luu" >Đăng ký</button>&nbsp;
