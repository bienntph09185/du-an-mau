                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contract_number" value="<?= $user['contract_number']?>">
                            </div>
                            <div class="form-group">
                                <label for="">Số chứng minh nhân dân</label>
                                <input type="text" class="form-control" name="identity_id" value="<?= $user['identity_id']?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
