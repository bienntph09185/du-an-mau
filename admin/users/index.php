...
checkAdminLoggedIn();
//kiểm tra tồn tại của keywword nếu bằng true thì bằng chính nó còn không thì trả về giá trị rỗng
$keyword = isset($_GET['keyword']) == true ? $_GET['keyword'] : "";
// lấy giá trị role ở url nếu true thì bằng chính nó còn k thì trả về giá trị rỗng
...
if($keyword !== ""){
    $getUsersQuery .= " where (u.email like '%$keyword%' 
                            or u.contract_number like '%$keyword%'  
                    ...
                    <table class="table table-stripped">
                        ...
                        <?php foreach ($users as $us): ?>
                            <tr>
                                ...
                                <td><?php echo $us['identity_id']?></td>
                                <td><?php echo $us['contract_number']?></td>
                                <td>
